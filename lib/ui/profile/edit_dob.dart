...
class _EditDobSheetState extends State<EditDobSheet> {
  ...
  List<DateTime> _getDaysInMonth() {
    ...
    final lastDayPrevMonth = DateTime(_currentMonth.year, _currentMonth.month, 0);
    for (int i = daysBefore - 1; i >= 0; i--) {
      days.add(DateTime(previousMonth.year, previousMonth.month, lastDayPrevMonth.day - i));
    }
  ...
  Widget build(BuildContext context) {
    final monthYear = '${_months[_currentMonth.month - 1]} ${_currentMonth.year}';
...
// Helper function
void showEditDobDialog(BuildContext context, {
  required String initialDob,
  required Function(String) onSave,
}) {
  showDialog(
    context: context,
    builder: (context) => EditDobSheet(
