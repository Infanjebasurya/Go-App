      ...
      Future.delayed(const Duration(seconds: 2), () {
        if (mounted) {
          setState(() {
            _messages.add(
              ChatMessage(
                text: "Hello sir, I am  near to your location.Reaching in 5 mins",
                isSentByMe: false,
                time: _getCurrentTime(),
              ),
            );
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                fontWeight: _messages.isEmpty ? FontWeight.w600 : FontWeight.w700,
                letterSpacing: 0.3,
              ),
            ),
            ...
            child: RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  ...
                  const TextSpan(
                    text: 'Reply to your message can be delayed as drivers don\'t reply while driving',
                  ),
                ],
              ),
            ),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.only(
              ...
              bottomLeft: message.isSentByMe ? const Radius.circular(18) : const Radius.circular(4),
              bottomRight: message.isSentByMe ? const Radius.circular(4) : const Radius.circular(18),
            ),
            boxShadow: [
              BoxShadow(
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              foregroundDecoration: _isFocused ? BoxDecoration(
                borderRadius: BorderRadius.circular(28),
                border: Border.all(
                  color: Colors.transparent,
                  width: 0,
              ...
              child: Container(
                ...
                child: Container(
                  ...
                  margin: _isFocused ? const EdgeInsets.all(1.5) : EdgeInsets.zero,
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.circular(_isFocused ? 26.5 : 28),
                  ),
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
